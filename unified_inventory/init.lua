...
uniinv_creative = false

if minetest.setting_getbool('uniinv_creative') ~= nil then
	uniinv_creative = minetest.setting_getbool('uniinv_creative')
end
...
if creative_inventory and uniinv_creative then
